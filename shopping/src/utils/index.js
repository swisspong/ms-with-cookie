...
module.exports.validateSignatureFromCookie = async (req) => {
  const signature = req.cookies?.acjid;
...
module.exports.publishMessage = (channel, service, msg, subscribers, topic) => {
